...
export default function JoinGroupPage() {
  ...
  if (error) {
    return (
      <div className="bg-gray-50 dark:bg-gray-900 flex items-center justify-center px-4 py-24">
        <div className="text-center">
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 relative min-h-full">
            ...
            <form action={handleJoinGroup} className="space-y-6">
              ...
              <div>
                <button
                  ...
                  className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium btn-success focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-200 cursor-pointer"
                >
                  🎁 Join Group
                </button>
              </div>
